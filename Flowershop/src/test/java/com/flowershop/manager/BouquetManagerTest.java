...
class BouquetManagerTest {
    ...
    void addFlower() {
        ...
        assertEquals(1, bouquetManager.getBouquet().getFlowers().size());
    ...
    void hasAccessoryOfType() {
        ...
        assertTrue(bouquetManager.hasAccessoryOfType(Basket.class));
        assertFalse(bouquetManager.hasAccessoryOfType(Ribbon.class));
    }
    ...
    void removeAccessoryOfType() {
        ...
        assertEquals(1, bouquetManager.getBouquet().getAccessories().size());
        assertTrue(bouquetManager.getBouquet().getAccessories().stream().anyMatch(a -> a instanceof Ribbon));
        assertFalse(bouquetManager.getBouquet().getAccessories().stream().anyMatch(a -> a instanceof Postcard));
    }
