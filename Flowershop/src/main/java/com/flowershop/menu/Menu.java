...
public class Menu {
    ...
    private List<MenuItem> currentMenu; // Зберігаємо поточне меню
    private List<MenuItem> mainMenu; // Зберігаємо головне меню для повернення
    ...
    private List<MenuItem> createMainMenu() {
    ...
    private List<MenuItem> createBouquetEditSubMenu() {
    ...
    private List<MenuItem> previousMenu; // Змінна для збереження попереднього меню
