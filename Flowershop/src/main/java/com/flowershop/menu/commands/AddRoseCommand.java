...
public class AddRoseCommand implements Command {
    ...
    public void execute() {
        ...
        String fragrance = getInput("Аромат троянди: ");

        // Створення об'єкта троянди та додавання його до букету
        Rose rose = new Rose(color, freshnessLevel, stemLength, flowerSize, price, originCountry, hasThorns, roseType);
        bouquetManager.addFlower(rose); // Додаємо троянду до букету
    ...
    // Метод для отримання введення користувача у вигляді логічного значення
