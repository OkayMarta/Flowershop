...
public class Wrapper extends Accessory {
    ...
    private String size; // Розмір обгортки

    // Конструктор з параметрами
    public Wrapper(String material, String color, double price, String size) {
    ...
    public String getUniqueCharacteristic() {
        return size.substring(size.indexOf(":") + 1).trim(); // Видаляємо "розмір: "
    }
}